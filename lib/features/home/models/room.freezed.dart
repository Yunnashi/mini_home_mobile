...
mixin _$Room {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, displayOrder);

  @override
  String toString() {
    return 'Room(id: $id, name: $name, displayOrder: $displayOrder)';
  }
}
...
abstract mixin class $RoomCopyWith<$Res> {
  factory $RoomCopyWith(Room value, $Res Function(Room) _then) =
      _$RoomCopyWithImpl;
  @useResult
  $Res call({int id, String name, int displayOrder});
}
...
extension RoomPatterns on Room {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String name, int displayOrder)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Room() when $default != null:
        return $default(_that.id, _that.name, _that.displayOrder);
      case _:
        return orElse();
    }
  }
...
class _Room implements Room {
  const _Room({required this.id, required this.name, this.displayOrder = 0});
