...
abstract mixin class $UpdateInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String? latestVersion, String? requiredVersion, String? enabledAt});
}
    ...
    return _then(_self.copyWith(
      latestVersion: freezed == latestVersion
          ...
          : latestVersion // ignore: cast_nullable_to_non_nullable
              as String?,
      requiredVersion: freezed == requiredVersion
          ? _self.requiredVersion
...
extension UpdateInfoPatterns on UpdateInfo {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UpdateInfo value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UpdateInfo() when $default != null:
        return $default(
            _that.latestVersion, _that.requiredVersion, _that.enabledAt);
      case _:
        return orElse();
    }
  }
...
class _UpdateInfo implements UpdateInfo {
  const _UpdateInfo({this.latestVersion, this.requiredVersion, this.enabledAt});
